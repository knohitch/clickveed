...
# Build with 1536 MB first; retry at 1024 MB if it fails.
# Then hard-fail if .next was not produced (catches silent OOM exits).
RUN NODE_OPTIONS="--max-old-space-size=1536" node_modules/.bin/next build --no-lint \
