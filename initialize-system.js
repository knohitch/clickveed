...
async function initializeSystem() {
  ...
  try {
    ...
    const apiKeys = [
      ...
      { name: 'wasabiEndpoint', value: process.env.WASABI_ENDPOINT || '' },
      { name: 'wasabiRegion', value: process.env.WASABI_REGION || '' },
      { name: 'wasabiBucket', value: process.env.WASABI_BUCKET || '' },
