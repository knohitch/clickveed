 ...
 * This server-side implementation matches the client-side one and supports
 * multiple AI providers (Google AI and OpenAI).
 * 
      ...
      return new ReadableStream({
        async start(controller) {
          try {
            ...
            // If there's a response promise, await it to catch any final errors
