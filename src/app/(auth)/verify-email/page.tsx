  ...
  useEffect(() => {
    const verifyToken = async () => {
      ...
      if (isSignupSuccess && !token) {
        setState('success');
        setMessage('Account created successfully! Please check your email for verification link.');
        return;
      }
      ...
      try {
        ...
        if (response.ok) {
          ...
          if (error === 'expired_token') {
            ...
            setMessage('Invalid verification link. Please check your email for correct link.');
          } else {
