...
export default function AdminSubscriptionsPage() {
  ...
  const { plans, loading: adminSettingsLoading } = useAdminSettings();
  ...
  const isLoading = adminSettingsLoading || loadingUsers;
                      ...
                      <TableCell>
                        <DropdownMenu>
                          ...
                          <DropdownMenuContent align="end">
                            ...
                            <DropdownMenuItem onSelect={() => handleAction('Cancel Subscription', user.displayName!)}>
                              Cancel Subscription
                            </DropdownMenuItem>
                            <DropdownMenuItem onSelect={() => handleAction('Issue Refund', user.displayName!)}>
                              Issue Refund
                            </DropdownMenuItem>
                          </DropdownMenuContent>
                        </DropdownMenu>
