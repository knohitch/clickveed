...
export function GoogleIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    ...
    >
        ...
        <path fill="#EA4335" d="M24,12c5.384,0,9.875,3.977,9.875,9.875c0,1.488-0.35,2.91-0.938,4.125h-9.937v-8h11.303c-0.792,2.237-2.231,4.166-4.087,5.574l6.19,5.238C36.971,39.205,44,34,44,24C44,18.063,39.813,12,24,12z"/>
    </svg>
  )
}
